...
<body>
    <table style="width:100%;">
        ...
        <tr>
            ...
            <td><a href="{{getenv("APP_FRONT_URL")}}/planning/jury/{{$token}}" target="_blank">lien d'accès à la plateforme web</a></td>
        </tr>
        <tr>
        ...
        <tr></tr>
        <tr>
            <td><img src="{!!$message->embedData(QrCode::format('png')->generate(getenv("APP_FRONT_URL")."/planning/jury/".$token), 'QrCode.png', 'image/png')!!}"></td>
        </tr>
    </table>
</body>
</html>
